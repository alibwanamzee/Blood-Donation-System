	...
	<div id="wrapper">
		...
		<div id="sidebar-nav" class="sidebar">
			<div class="sidebar-scroll">
				<nav>
					<ul class="nav">
						<li><a href="admin_dashboard.php" class=" menu-item " onclick="toggleActive(this)"><i class="lnr lnr-home"></i> <span>Dashboard</span></a></li>
						<li><a href="state.php" class="menu-item" onclick="toggleActive(this)"><i class="lnr lnr-code"></i> <span>State</span></a></li>
						<li><a href="city.php" class="menu-item" onclick="toggleActive(this)"><i class="lnr lnr-chart-bars"></i> <span>City</span></a></li>
						<li><a href="members.php" class="menu-item" onclick="toggleActive(this)"><i class="lnr lnr-cog"></i> <span>Members</span></a></li>
						<li><a href="donor.php" class="menu-item" onclick="toggleActive(this)"><i class="lnr lnr-alarm"></i> <span>Non Active Donors</span></a></li>
						<li>
