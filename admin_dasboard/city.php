...
<div class="main">
         ...
         <h2>Welcome, <span style="color: blue"><?php echo $_SESSION['username']?></span> <br />Manage City </h2> <br />
          <p><button type="button" class="btn btn-primary" data-toggle="modal" data-target="#addcity">Add New City</button></p> <br />           
